...
OUTPUTS_DIR = BASE_DIR / "tvae" / "outputs"
...
# Identifie les colonnes discrètes ou catégorielles du dataset pour les déclarer correctement lors de l'entraînement du modèle TVAE.
